...
import { PortBase } from "../PortBase.sol";
 ...
 */
contract GettersAndDerivers is PortBase {
    /**
    ...
    constructor(address conduitController)
        PortBase(conduitController)
    {}

    // function __init_GetterAndDerivers(address conduitController) internal  {
    //     __init_PortBase(conduitController);
    // }
    ...
    function _deriveOrderHash(
        ...
        console.log("In GettersAndDerivers.sol , _deriveOrderHash()");
    ...
    {
        console.log("In GettersAndDerivers.sol , _deriveConduit()");
    ...
    function _domainSeparator() internal view returns (bytes32) {
        ...
        console.log("In GettersAndDerivers.sol , _domainSeparator()");
        // prettier-ignore
    ...
    {
        console.log("In GettersAndDerivers.sol , _deriveEIP712Digest()");
