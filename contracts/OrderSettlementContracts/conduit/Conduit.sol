...
contract Conduit is ConduitInterface, TokenTransferrer {
  ...
  //  error InvalidERC721TransferAmount();
    ...
    {
        console.log("In Conduit.sol , execute()");
    ...
    function executeBatch1155(
        ...
        console.log("In Conduit.sol , executeBatch1155()");
    ...
    function executeWithBatch1155(
        ...
        console.log("In Conduit.sol , executeWithBatch1155()");
    ...
    function updateChannel(address channel, bool isOpen) external override {
        ...
        console.log("In Conduit.sol , updateChannel()");
    ...
    function _transfer(ConduitTransfer calldata item) internal {
        ...
        console.log("In Conduit.sol , _transfer()");
