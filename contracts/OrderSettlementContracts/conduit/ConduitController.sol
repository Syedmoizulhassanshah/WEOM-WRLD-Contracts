...
contract ConduitController is ConduitControllerInterface {
    ...
    {
        console.log("In ConduitController.sol , createConduit()");
    ...
    function updateChannel(
        ...
        console.log("In ConduitController.sol , updateChannel()");
    ...
    function transferOwnership(address conduit, address newPotentialOwner)
        ...
        override
    {
        console.log("In ConduitController.sol , transferOwnership()");
    ...
    function cancelOwnershipTransfer(address conduit) external override {
        ...
        console.log("In ConduitController.sol , cancelOwnershipTransfer()");
    ...
    function acceptOwnership(address conduit) external override {
        ...
        console.log("In ConduitController.sol , acceptOwnership()");
    ...
    {
        console.log("In ConduitController.sol , ownerOf()");
    ...
    {
        console.log("In ConduitController.sol , getKey()");
    ...
    {
        console.log("In ConduitController.sol , getConduit()");
    ...
    {
        console.log("In ConduitController.sol , getPotentialOwner()");
    ...
    function getChannelStatus(address conduit, address channel)
        ...
        returns (bool isOpen)
    {
        console.log("In ConduitController.sol , getChannelStatus()");
        ...
        returns (uint256 totalChannels)
    {
        ...
        console.log("In ConduitController.sol , getTotalChannels()");
    ...
    {
        console.log("In ConduitController.sol , getChannel()");
    ...
    {
        console.log("In ConduitController.sol , getChannels()");
        ...
        returns (bytes32 creationCodeHash, bytes32 runtimeCodeHash)
    {
        ...
        console.log("In ConduitController.sol , getConduitCodeHashes()");
    ...
    function _assertCallerIsConduitOwner(address conduit) private view {
        ...
        console.log("In ConduitController.sol , _assertCallerIsConduitOwner()");
    ...
    function _assertConduitExists(address conduit) private view {
        ...
        console.log("In ConduitController.sol , _assertConduitExists()");
